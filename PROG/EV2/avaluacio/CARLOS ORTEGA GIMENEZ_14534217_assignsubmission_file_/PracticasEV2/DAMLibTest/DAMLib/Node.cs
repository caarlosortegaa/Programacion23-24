namespace DAMLib
{
    ...
    public class Node<T>
    {
        ...
        // Javi: MAL!!!!!!!!!!!!
        // Javi: MAL!!!!!!!!!!!!
        // Javi: Sólo esto hace que no funcione la clase
        ...
        {
            if(_parent != null)
            _parent._children.Remove(this); // Javi: No dije que no podíamos usar esta función de la lista???
            _parent = null;
        }
        ...
        {
            // Javi: Mal, no lo pones como padre
            if (parent == null)
                return;
            else
